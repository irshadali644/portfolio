      ...
      <div className="container">
        ...
        <div className="about-container">
            ...
            <div className="about-me-image">
              <div className="about-cards">
                <article className="about-card">
                  ...
                  <small>Currently working in mccoymart</small>
                </article>
                <article className="about-card">
                  <div>
          ...
          <div className="about-content">
            <p>
              My name is Md. Irshad Ansari, and I am a full stack software
              developer with a degree from V.B.U University. With four years
